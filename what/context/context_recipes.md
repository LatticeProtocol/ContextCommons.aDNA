...
## Context Commons — Domain-Specific Recipes

Recipes specific to the Context Commons program. These assemble CC-specific context topics for program work.

### CC — Curriculum & Program Design

| Recipe | Topics Used | Subtopics (Standard Load) | ~Tokens | Use When |
|--------|------------|---------------------------|---------|----------|
| `curriculum_design` | program_design + curriculum_framework + adna_for_communities | thesis, core_principles, program_architecture + all curriculum_framework + adna_simplified | ~15K | Creating or reviewing curriculum modules, designing track structure |
| `pilot_planning` | program_design + pilot_programs + community_engagement | thesis, program_architecture, governance_model + all pilot_programs + all community_engagement | ~14K | Planning or evaluating pilot programs, community onboarding |
...
| Keywords in Task | Recipe Match |
|-----------------|--------------|
| curriculum, module, track, builder track, steward track, elder track, lesson | `curriculum_design` |
| pilot, Grand Rapids, Los Angeles, Peter's Church, LAUSD, community launch | `pilot_planning` |
...
| Recipe | Minimal (~5K) | Standard (~12-18K) | Full |
|--------|--------------|-------------------|------|
| `curriculum_design` | thesis + program_architecture | + all curriculum_framework + adna_simplified | + all program_design + all adna_for_communities |
| `pilot_planning` | thesis + governance_model | + all pilot_programs + all community_engagement | + all program_design + use_case_domains |
...
> **Note**: Program design (~9K) is **active** and III-reviewed (avg quality 3.8). Curriculum framework (~9.2K) is **active** and III-reviewed (avg quality 4.2). Community engagement (~9.1K) is **active** and III-reviewed (avg quality 4.37). aDNA for communities (~3.5K) is **seeded** (DRAFT, pending community review). Fundraising (~14K) is **active** and fully loaded. Pilot programs and use case domains are **planned** — they will be created during campaign_context_commons_genesis missions M04-M06.
